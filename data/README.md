...
- The September 9, 2026 API test retrieved 55 date records, 216 chamber-condition records, and 828 tube records. Parsing the original GitHub CSV also gives 828 records and 828 unique identifiers. Quoted notes contain line breaks, so text-line counts are not record counts. Neither source has been overwritten.
